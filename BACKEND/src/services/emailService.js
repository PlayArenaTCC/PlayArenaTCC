...
async function sendVerificationEmail({ to, code, name }) {
  ...
  console.info(`[E-mail local] Enviando código PlayArena para ${to}: ${code}`);
...
async function sendWithGmail({ html, subject, text, to }) {
  try {
    ...
    console.info(`[E-mail Gmail] Enviado para ${to}. Message ID: ${info.messageId}`);
    ...
    console.error('[E-mail Gmail] Erro ao enviar:', error.message);
...
async function sendWithSMTP({ html, subject, text, to }) {
  try {
    ...
    console.info(`[E-mail SMTP] Enviado para ${to}. Message ID: ${info.messageId}`);
    ...
    console.error('[E-mail SMTP] Erro ao enviar:', error.message);
