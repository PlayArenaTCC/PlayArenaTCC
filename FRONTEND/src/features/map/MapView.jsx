          ...
          <div className="map-list">
            {unpositionedCount > 0 && (
              <p className="map-location-warning">
                {unpositionedCount} {unpositionedCount === 1 ? 'espaco nao possui' : 'espacos nao possuem'} localizacao precisa e nao {unpositionedCount === 1 ? 'sera exibido' : 'serao exibidos'} no mapa.
              </p>
            )}
            {courtPoints.map((point) => (
              <article
