  ...
  return (
    <>
      ...
      <div className="court-card-body">
        ...
        <p>
          <MapPin size={15} />
          {formatCourtAddress(quadra, 'Localidade não informada')}
        </p>
          ...
          <div className="owner-schedule-manager" onClick={(event) => event.stopPropagation()}>
            <form className="owner-court-edit-form" onSubmit={submitEdit}>
              <div className="owner-schedule-active">
                ...
                <p>Altere apenas o preço geral, fotos e comodidades da quadra.</p>
              </div>

              <label>
                <span>Preço geral exibido na vitrine</span>
                      ...
                      {group.items.map((horario) => (
                        <div className="owner-schedule-row" key={horario.id}>
                          ...
                          <div className="owner-schedule-row-actions">
                            <button className="schedule-disable-button" type="button" title="Inativar horário" aria-label="Inativar horário" onClick={() => onUpdateScheduleAvailability?.(quadra, horario, false)}>
                              <EyeOff size={13} />
                            </button>
                            <button className="schedule-delete-button" type="button" title="Apagar horário" aria-label="Apagar horário" onClick={() => onDeleteSchedule?.(quadra, horario)}>
                              <Trash2 size={13} />
                            </button>
                          </div>
                        </div>
                    ...
                    <div className="owner-schedule-group is-inactive" key={group.label}>
                      ...
                      {group.items.map((horario) => (
                        <div className="owner-schedule-row is-inactive" key={horario.id}>
                          ...
                          <div className="owner-schedule-row-actions">
                            <button className="schedule-reactivate-button" type="button" title="Reativar horário" aria-label="Reativar horário" onClick={() => onUpdateScheduleAvailability?.(quadra, horario, true)}>
                              <Eye size={13} />
                            </button>
                            <button className="schedule-delete-button" type="button" title="Apagar horário" aria-label="Apagar horário" onClick={() => onDeleteSchedule?.(quadra, horario)}>
                              <Trash2 size={13} />
            ...
            <form className="schedule-form" onSubmit={submitSchedule}>
              <div className="schedule-type-toggle" role="group" aria-label="Tipo de horário">
